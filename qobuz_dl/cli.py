    ...
    try:
        if arguments.command == "dl":
            ...
            for id in arguments.ID:
                downloader.download_id_by_type(qobuz, id, arguments.directory, arguments.quality, True, arguments.embed_art)
        elif arguments.command == "track":
            for id in arguments.ID:
                downloader.download_id_by_type(qobuz, id, arguments.directory, arguments.quality, False, arguments.embed_art)
        elif arguments.command == "favs":
            download_favorites(qobuz, arguments.directory + "/" + arguments.file)
        else:
